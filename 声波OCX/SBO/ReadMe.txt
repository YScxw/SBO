========================================================================
    ACTIVEX 控件 DLL : SBO 项目概述
========================================================================

控件向导已为 SBO ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 SBO ActiveX 控件 DLL 的每个文件的内容。
...
SBOCtrl.h
    此文件包含 CSBOCtrl C++ 类的声明。

SBOCtrl.cpp
    此文件包含 CSBOCtrl C++ 类的实现。

SBOPropPage.h
    此文件包含 CSBOPropPage C++ 类的声明。

SBOPropPage.cpp
    此文件包含 CSBOPropPage C++ 类的实现。

CSBOCtrl.bmp
    此文件包含一个位图，当 CSBOCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 SBO.pch 的预编译头 (PCH) 文件和名为 
